...
class Tenant extends Model
{
    ...
    protected function casts(): array
    {
        return [
            ...
            'notify_owner_payment_received' => 'boolean',
            'notify_owner_utility_reminder_day' => 'boolean',
            'notify_owner_invoice_create_day' => 'boolean',
            'notify_owner_invoice_send_day' => 'boolean',
            'notify_owner_overdue_digest' => 'boolean',
            'deleted_at' => 'datetime',
        ];
    }
